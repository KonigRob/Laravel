...
@section('data')
    ...
    <div>
        <script type="text/javascript"
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCs5lzlcBGmusT8feHcOfQ8HMEVmcjuXcc&libraries=places"></script>
        ...
        {!! Form::email('website', null, ['class'=>'form-control']) !!}

        {!! Form::label('mobilephone', 'Phone Number:') !!}
        {!! Form::text('mobilephone', null, ['class'=>'form-control']) !!}


        <label for="locationTextField">Location</label>
        <input id="locationTextField" type="text" class="form-control">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCs5lzlcBGmusT8feHcOfQ8HMEVmcjuXcc&libraries=places&callback=initAutocomplete"
                async defer></script>
